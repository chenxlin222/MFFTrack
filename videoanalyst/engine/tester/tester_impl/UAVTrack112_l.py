...
from videoanalyst.evaluation.got_benchmark.experiments.UAVTrack112_l import ExperimentUAVTrack112_l
...
class UAVTrack112lTester(TesterBase):
    r"""OTB tester
    ...
    def __init__(self, *args, **kwargs):
        super(UAVTrack112lTester, self).__init__(*args, **kwargs)
    ...
    def test(self, vis=False):
        ...
        for subset in self._hyper_params["subsets"]:
            ...
            experiment = ExperimentUAVTrack112_l(root_dir,
                                          version=subset,
...
UAVTrack112lTester.default_hyper_params = copy.deepcopy(UAVTrack112lTester.default_hyper_params)
UAVTrack112lTester.default_hyper_params.update(UAVTrack112lTester.extra_hyper_params)
