...
from videoanalyst.evaluation.got_benchmark.experiments.UAV123_10fps import ExperimentUAV123_10fps
...
class UAV10fpsTester(TesterBase):
    r"""OTB tester
    ...
    extra_hyper_params = dict(
        device_num=1,
        data_root="datasets/UAV123_10fps",
        subsets=["UAV123_10fps"],  # (UAV123|UAV20L)
    )

    def __init__(self, *args, **kwargs):
        super(UAV10fpsTester, self).__init__(*args, **kwargs)
    ...
    def test(self, vis=False):
        ...
        for subset in self._hyper_params["subsets"]:
            ...
            experiment = ExperimentUAV123_10fps(root_dir,
                                          version=subset,
            ...
            if nr_devs == 1:
                ...
                experiment.run(pipeline_tracker,visualize=vis)
            # multi-worker
            else:
                procs = []
...
UAV10fpsTester.default_hyper_params = copy.deepcopy(UAV10fpsTester.default_hyper_params)
UAV10fpsTester.default_hyper_params.update(UAV10fpsTester.extra_hyper_params)
