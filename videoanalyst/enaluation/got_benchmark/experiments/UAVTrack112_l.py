...
from ..datasets.UAVTrack112_l import UAVTrack112_l
from ..utils.metrics import rect_iou, center_error


class ExperimentUAVTrack112_l(ExperimentOTB):
    ...
    def __init__(self, root_dir, version='UAV123',
        ...
        assert version.upper() in ['UAV123', 'UAVTRACK112_L']
        self.dataset = UAVTrack112_l(root_dir, version)
