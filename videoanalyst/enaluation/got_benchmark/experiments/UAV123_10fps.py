...
from ..datasets.UAV123_10fps import UAV123_10fps
from ..utils.metrics import rect_iou, center_error


class ExperimentUAV123_10fps(ExperimentOTB):
    ...
    def __init__(self, root_dir, version='UAV123_10fps',
                 result_dir='results', report_dir='reports'):

        assert version.upper() in ['UAV123_10FPS']
        self.dataset = UAV123_10fps(root_dir, version)
