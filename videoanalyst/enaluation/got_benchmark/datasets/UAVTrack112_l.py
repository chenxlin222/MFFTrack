...
class UAVTrack112_l(object):
    ...
    def __init__(self, root_dir, version='UAV123'):
        super(UAVTrack112_l, self).__init__()
        assert version.upper() in ['UAV20L', 'UAV123','UAVTRACK112_L']
