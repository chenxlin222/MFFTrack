...
from .fusion import builder as fusion_builder
...
def get_config(task_list: List) -> Dict[str, CfgNode]:
    ...
    for task in cfg_dict:
        ...
        cfg["fusion"] = fusion_builder.get_config(task_list)[task]
