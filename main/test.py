...
def make_parser():
    ...
    parser.add_argument('-cfg',
                        '--config',      #     mobilenetv3_fusion_v3   mobilenet_test_encoder6_48 mobilenet_test_fusion
                         default='/home/droneyee/video_analyst/experiments/mymodel/test/mobilenet_l4_test_fusion.yaml',
                       # default='/home/droneyee/video_analyst/experiments/mymodel/test/mobilenet_test_DepthwiseRPN.yaml',
                        #default='/home/droneyee/video_analyst/experiments/mymodel/test/mobilenet_large_test_fusion.yaml',
                        # default='/home/droneyee/video_analyst/experiments/mymodel/test/mobilenet_test_fusionXX.yaml',
                        type=str,
