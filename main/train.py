...
def make_parser():
    ...
    parser.add_argument('-cfg',
                        '--config',  # mobilenetv3_transformer_fusionX mobilenetv3_TPN_transformer_fusion  mobilenetv3_x3_transformer_fusion
                        default='/home/yinyuxiao/video_analyst/experiments/mymodel/train/Alexnet_transformer_fusion.yaml',
                        type=str,
