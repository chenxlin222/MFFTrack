...
def make_parser():
    ...
    parser.add_argument('-cfg',  # mobilenet_TPN_test_fusion
                        '--config',  # mobilenet_l4_test_fusion  mobilenet_large_test_fusion mobilenet_test_fusionX  mobilenetv3_fusion_v3
                        default='/home/yinyuxiao/video_analyst/experiments/mymodel/test/mobilenet_l4_test_fusion.yaml',
                        type=str,
